...
#         self.logo = tk.PhotoImage(file = "/home/hallvard/Dokumenter/Untitled.gif")
#         tk.Label(self.wndw, image=self.logo).grid(row = 0, column = 1)
...
# with open('pipeline_parameters.txt', 'w') as file_:
#     for i in pipe_start.return_output_list():
#         file_.write(i+'\n')
